        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-white">
          <div className="max-w-3xl space-y-6">
            ...
            <div className="pt-4 flex flex-col sm:flex-row gap-4">
              <Link
                to="/contact"
                className="inline-flex items-center justify-center rounded-full bg-brand-teal text-white hover:bg-brand-teal-deep px-8 py-3.5 text-sm font-semibold shadow-lg shadow-black/20 transition-all hover:scale-105"
              >
                Book a Consultation
              </Link>
              <Link
